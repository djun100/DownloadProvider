...
public class DownloadAdapter extends CursorAdapter {
    public final static String TAG=DownloadAdapter.class.getName(); 
    ...
    final private int mUriColumnId;
    ...
    public View newView() {
        DownloadItemLayout view = (DownloadItemLayout) LayoutInflater.from(mContext).inflate(R.layout.download_list_item, null);
        view.setSelectListener(mDownloadSelectionListener);
        return view;
    }

    public void bindView(View convertView) {
        if (!(convertView instanceof DownloadItemLayout)) {
            return;
        }
        long downloadId = mCursor.getLong(mIdColumnId);
        ((DownloadItemLayout) convertView).setDownloadId(downloadId);
        ...
        setTextForView(convertView, R.id.size_text, getSizeText(currentBytes)+"/"+getSizeText(totalBytes));
