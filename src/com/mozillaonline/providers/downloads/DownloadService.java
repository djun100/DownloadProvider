...
public class DownloadService extends Service {
    ...
    private void trimDatabase() {
        Cursor cursor = getContentResolver().query(Downloads.ALL_DOWNLOADS_CONTENT_URI, new String[] { Downloads._ID },
        ...
        if (cursor.moveToFirst()) {
            ...
            while (numDelete > 0) {
                Uri downloadUri = ContentUris.withAppendedId(Downloads.ALL_DOWNLOADS_CONTENT_URI,
